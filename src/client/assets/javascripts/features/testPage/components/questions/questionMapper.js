...
const questionsMapper = [
  ...
  },
  {
    ...
    answers: [
      ...
      {ans: 'Изучу лор игры, буду восхищаться каждой локацией', id: 10, weight: 0.5}, // Юзя
      {ans: 'Буду пить пиво и орать в монитор', id: 4, weight: 0.5}] // Хован
  },
  {
    question: "Чтобы ты делал если бы попал в сказочную страну?",
    answers: [
      {ans: 'Переспал бы с Принцесса Пич', id: 9, weight: 0.5}, // Нюк
  ...
  },
  {
    ...
    answers: [
      ...
      {ans: 'хз', id: 5, weight: 0.5}] // Виловгей
  },
];
